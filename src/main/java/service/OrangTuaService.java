...
public class OrangTuaService {
    ...
    // CREATE
    public void tambahOrangTua(Scanner pemindai) {
        System.out.println("\n--- Tambah Data Orang Tua ---");
        String id = InputValidator.ambilTeksWajibIsi(pemindai, "ID Orang Tua: ");
        if (cariOrangTua(id) != null) {
            System.out.println("Gagal! ID Orang Tua sudah digunakan.");
            return;
        }
        String nama = InputValidator.ambilTeksWajibIsi(pemindai, "Nama Orang Tua: ");
        long noHp = InputValidator.ambilNomorHp(pemindai, "No HP: ");
        String alamat = InputValidator.ambilTeksWajibIsi(pemindai, "Alamat: ");
    ...
    // UPDATE
    public void perbaruiOrangTua(Scanner pemindai) {
        System.out.println("\n--- Update Data Orang Tua ---");
        String id = InputValidator.ambilTeksWajibIsi(pemindai, "Masukkan ID Orang Tua yang akan diupdate: ");
        ...
        long noHp = InputValidator.ambilNomorHp(pemindai, "No HP Baru: ");
        String alamat = InputValidator.ambilTeksWajibIsi(pemindai, "Alamat Baru: ");
    ...
    // DELETE
    public void hapusOrangTua(Scanner pemindai) {
        System.out.println("\n--- Hapus Data Orang Tua ---");
        String id = InputValidator.ambilTeksWajibIsi(pemindai, "Masukkan ID Orang Tua yang akan dihapus: ");
        OrangTua orangTua = cariOrangTua(id);
        if (orangTua == null) {
            System.out.println("Data dengan ID tersebut tidak ditemukan!");
            return;
