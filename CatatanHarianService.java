...
public class CatatanHarianService {
    ...
    // CREATE
    public void tambahCatatan(Scanner scanner) {
        ...
        String idAnak;
        while (true) {
            idAnak = InputValidator.getNonEmptyString(scanner, "ID Anak: ");
        ...
        String tanggal = InputValidator.getDate(scanner, "Tanggal (YYYY-MM-DD): ");
        String aktivitas = InputValidator.getNonEmptyString(scanner, "Aktivitas: ");
    ...
    public void tampilkanRiwayatAnak(Scanner scanner) {
        System.out.println("\n--- Riwayat Aktivitas Harian Anak ---");
        String idAnak = InputValidator.getNonEmptyString(scanner, "Masukkan ID Anak: ");
        if (anakService.cariAnak(idAnak) == null) {
    ...
    // UPDATE
    public void updateCatatan(Scanner scanner) {
        System.out.println("\n--- Edit Laporan Aktivitas Harian ---");
        String id = InputValidator.getNonEmptyString(scanner, "Masukkan ID Catatan yang akan diedit: ");
        ...
        String tanggal = InputValidator.getDate(scanner, "Tanggal Baru (YYYY-MM-DD): ");
        String aktivitas = InputValidator.getNonEmptyString(scanner, "Aktivitas Baru: ");
    ...
    // DELETE
    public void hapusCatatan(Scanner scanner) {
        System.out.println("\n--- Hapus Laporan Aktivitas Harian ---");
        String id = InputValidator.getNonEmptyString(scanner, "Masukkan ID Catatan yang akan dihapus: ");
        CatatanHarian catatan = cariCatatan(id);
        if (catatan == null) {
            System.out.println("Catatan dengan ID tersebut tidak ditemukan!");
            return;
